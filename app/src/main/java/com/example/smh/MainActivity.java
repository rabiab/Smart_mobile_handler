    ...
    private void initViews() {
        ...
        messageList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String getPhoneNumber = recordsStored.get(position).messageNumber;
                Intent mianIntent = new Intent(MainActivity.this, ChatActivity.class);
                mianIntent.putExtra("userPhoneNumber", getPhoneNumber);
